...
const ALIASES_RECEITA: Record<string, string> = {
  ...
  // ── Guarnições fixas: Arroz/Feijão base ─────────────────────────────────
  'arroz':                                        'Arroz branco',
  'arroz e feijao (reduzido)':                    'Arroz e Feijão',
  'arroz e feijao carioca':                       'Feijão carioca',
  'arroz e feijao preto':                         'Feijão preto',
  'arroz e feijao temperado':                     'Arroz e Feijão',
  'feijao':                                       'Feijão carioca',
  // ── Guarnições: itens extras com espaço após parêntese ──────────────────
  'alface e tomate':                              'Salada de Alface com Tomate',
  'arroz a grega ( milho e salsa)':               'Arroz à grega',
  'arroz a grega- milho':                         'Arroz à grega',
  'farofa':                                       'Farofa de bacon',
  'pure de batata ( pronto)':                     'Purê de batata',
  // ── Sobremesas: variantes com espaço após parêntese ──────────────────────
  'napolitano ( pudim morango e chocolate)':      'Pudim de leite condensado',
  'pudim de corte ( morango)':                    'Pudim de leite condensado',
  'supresa de abacaxi':                           'Surpresa de abacaxi',
  // ── Saladas: Alface crespa variantes ────────────────────────────────────
  'alface com tomate ( cebola a parte)':          'Salada de Alface com Tomate',
  'alface com tomate e cebola a parte':           'Salada de Alface com Tomate',
  'alface crespa , pepino e tomate':              'Salada de Alface com Tomate',
  'alface crespa , tomate e pepino':              'Salada de Alface com Tomate',
  'alface crespa com cenoura ralada e cebola a aparte': 'Salada de Alface com Tomate',
  'alface crespa com manga':                      'Salada Tropical de Alface com Manga',
  'alface crespa com tomate':                     'Salada de Alface com Tomate',
  'alface crespa com tomate e cebola':            'Salada de Alface com Tomate',
  'alface crespa com tomate e pepino':            'Salada de Alface com Tomate',
  'alface crespa e tomate':                       'Salada de Alface com Tomate',
  'alface crespa tomate e cebola':                'Salada de Alface com Tomate',
  'alface crespa tomate e cenoura ralada':        'Salada de Alface com Tomate',
  'alface crespa tomate e pepino':                'Salada de Alface com Tomate',
  'alface crespa, tomate e cenoura ralada':       'Salada de Alface com Tomate',
  'alface crespa, tomate e pepino':               'Salada de Alface com Tomate',
  // ── Saladas: Alface lisa e outras variantes ──────────────────────────────
  'alface e cenoura ralada':                      'Salada de Alface com Tomate',
  'alface e rucula':                              'Salada verde com rúcula',
  'alface lisa com cenoura':                      'Salada de Alface com Tomate',
  'alface lisa com cenoura ralada':               'Salada de Alface com Tomate',
  'alface lisa com tomate':                       'Salada de Alface com Tomate',
  'alface lisa com tomate e cebola a parte':      'Salada de Alface com Tomate',
  'alface lisa tomate e pepino':                  'Salada de Alface com Tomate',
  'alface lisa, com tomate e cebola a parte':     'Salada de Alface com Tomate',
  'alface lisa, pepino e tomate':                 'Salada de Alface com Tomate',
  'alface lisa, tomate e pepino':                 'Salada de Alface com Tomate',
  'alface, pepino e tomate':                      'Salada de Alface com Tomate',
  'alface, pepino, tomate e cebola roxa':         'Salada de Alface com Tomate',
  'alface, tomate e cebola':                      'Salada de Alface com Tomate',
  'alface, tomate e cenoura ralada':              'Salada de Alface com Tomate',
  'alface, tomate e pepino':                      'Salada de Alface com Tomate',
  'alface/mix de folhas':                         'Mix de Folhas com Cenoura',
  // ── Saladas: Batata ───────────────────────────────────────────────────────
  'batata e cebola':                              'Salada de Batata',
  'batata e cenoura cozida':                      'Salada de Batata',
  // ── Saladas: Beterraba variantes ─────────────────────────────────────────
  'beterraba + acelga':                           'Salada de Beterraba Cozida',
  'beterraba + cenoura ralada':                   'Salada de Beterraba Cozida',
  'beterraba a vapor':                            'Salada de Beterraba Cozida',
  'beterraba com agriao':                         'Salada de Beterraba Cozida',
  'beterraba com cenoura cozida':                 'Salada de Beterraba Cozida',
  'beterraba com cenoura ralada':                 'Salada de Beterraba Cozida',
  'beterraba com cenoura ralado':                 'Salada de Beterraba Cozida',
  'beterraba cozida':                             'Salada de Beterraba Cozida',
  'beterraba e acelga':                           'Salada de Beterraba Cozida',
  'beterraba e cenoura cozida':                   'Salada de Beterraba Cozida',
  'beterraba e cenoura palito':                   'Salada de Beterraba Cozida',
  'beterraba e cenoura ralada':                   'Salada de Beterraba Cozida',
  'beterraba ralada':                             'Salada de Beterraba Cozida',
  'beterraba ralada com cenoura':                 'Salada de Beterraba Cozida',
  'beterrada ralada':                             'Salada de Beterraba Cozida',
  // ── Saladas: Brócolis variantes ───────────────────────────────────────────
  'brocolis com cenoura':                         'Brócolis no Alho',
  'brocolis com cenoura a vapor':                 'Brócolis no Alho',
  'brocolis com couve - flor':                    'Couve-Flor Gratinada',
  'brocolis e cenoura a vapor':                   'Brócolis no Alho',
  'brocolis ninja':                               'Brócolis no Alho',
  'brocolis, cenoura a vapor':                    'Brócolis no Alho',
  // ── Saladas: Cenoura variantes ────────────────────────────────────────────
  'cenoura + tomate':                             'Salada de Cenoura Ralada',
  'cenoura com beterraba ralada':                 'Salada de Beterraba Cozida',
  'cenoura ralada':                               'Salada de Cenoura Ralada',
  'cenoura ralada com beterraba':                 'Salada de Beterraba Cozida',
  // ── Saladas: Chuchu variantes ─────────────────────────────────────────────
  'chuchu':                                       'Chuchu refogado',
  'chuchu com cebola roxa':                       'Chuchu refogado',
  'chuchu com cenoura':                           'Chuchu refogado',
  'chuchu com tomate':                            'Chuchu refogado',
  'chuchu e cenoura':                             'Chuchu refogado',
  // ── Saladas: Couve variantes ──────────────────────────────────────────────
  'couve com tomate':                             'Couve refogada',
  'couve com tomate e cebola':                    'Couve refogada',
  'couve com tomate e cebola a parte':            'Couve refogada',
  'couve flor e brocolis gratinados':             'Couve-Flor Gratinada',
  'couve manteiga com tomate':                    'Couve refogada',
  'couve manteiga refogada':                      'Couve refogada',
  'couve manteiga refogado':                      'Couve refogada',
  'couve refogado':                               'Couve refogada',
  // ── Saladas: Espinafre ────────────────────────────────────────────────────
  'espinafre com cenoura ralada':                 'Mix de Folhas com Cenoura',
  // ── Saladas: Legumes variantes ────────────────────────────────────────────
  'de legumes':                                   'Legumes Refogados',
  'de legumes chuchu / batata e cenoura':         'Legumes Refogados',
  'legumes':                                      'Legumes Refogados',
  'legumes ( batata e cenoura)':                  'Legumes Refogados',
  'legumes ( cenoura, batata e chuchu)':          'Legumes Refogados',
  'legumes (chuchu, cenoura e batata)':           'Legumes Refogados',
  // ── Saladas: Macarrão ─────────────────────────────────────────────────────
  'de macarrao':                                  'Maionese de Legumes',
  'de macarrao com milho':                        'Maionese de Legumes',
  // ── Saladas: Maionese variantes ───────────────────────────────────────────
  'maionese':                                     'Maionese de Legumes',
  'maionese ( batata com cenoura)':               'Maionese de Legumes',
  'maionese ( batata e cenoura)':                 'Maionese de Legumes',
  'maionese e batata rustica com alecrim':        'Maionese de Legumes',
  // ── Saladas: Mix de Folhas variantes ─────────────────────────────────────
  'mix de folhas':                                'Mix de Folhas com Cenoura',
  'mix de folhas , tomate e cebola roxa':         'Mix de Folhas com Cenoura',
  'mix de folhas ( alface crespa/ lisa , tomate e cebola a parte)': 'Mix de Folhas com Cenoura',
  'mix de folhas ( alface, couve e tomate)':      'Mix de Folhas com Cenoura',
  'mix de folhas alface, couve e tomate':         'Mix de Folhas com Cenoura',
  'mix de salada verde com cenoura':              'Mix de Folhas com Cenoura',
  // ── Saladas: Pepino ───────────────────────────────────────────────────────
  'pepino com tomate':                            'Salada de Pepino',
  // ── Saladas: Repolho variantes ────────────────────────────────────────────
  'repolho + cenoura':                            'Salada de Repolho com Cenoura',
  'repolho + cenoura ralada':                     'Salada de Repolho com Cenoura',
  'repolho com cebola refogada':                  'Salada de Repolho com Cenoura',
  'repolho com cenoura ralada':                   'Salada de Repolho com Cenoura',
  'repolho com maca':                             'Coleslaw',
};
